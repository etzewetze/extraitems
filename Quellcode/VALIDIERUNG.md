...
| Automatisierte Tests gegen Basis-API | 42 Tests, 0 Fehler, 0 Fehlschläge, 0 übersprungen |
| Dieselben Tests gegen neueste API | 42 Tests, 0 Fehler, 0 Fehlschläge, 0 übersprungen |
| JSON-/Manifest-/Modellreferenzprüfung | 80 Packdateien, 3 Pflanzen × 4 Stufen, 10 Käsestufen und 12 Itemmodelle vollständig |
...
- **6 Assetfälle:** neun eigene Zweierpotenz-RGBA-Texturen; reife Tomate ohne Abhängigkeit von der eigenen PNG; Ground-Transformationen für Quader-Items; fünf reparierte extrudierte Küchen-Sprites; drei vollständige Wachstumsreihen; zehn Käserad-Portionen.
...
- **3 Küchen-Definitionsfälle:** das exakte Käsestationsraster mit beliebigen Brettern, die gewünschten Nahrungswerte und die fünf Zutaten des Cheesy Schlemmers.
